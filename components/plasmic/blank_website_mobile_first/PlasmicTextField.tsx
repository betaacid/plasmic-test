...
import Label from "../../Label"; // plasmic-import: PE13HXCMYwVe/component
import TextInput from "../../TextInput"; // plasmic-import: CoV1NJVM_fz7/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 3MbEox0f9O6X/component
import Description from "../../Description"; // plasmic-import: BmUz5s-gd2KP/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: rdfZLaxRGh3N/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__uf6Mx, {
          [sty.freeBoxiconEnd__uf6MxlgFeB]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__uf6MxhVqyK]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__uf6MXfdDRy]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__ny6Qh, {
            [sty.freeBoxiconStart__ny6QhHVqyK]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__ny6QhfdDRy]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___4KlOf)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__dUgkN, {
            [sty.freeBoxiconEnd__dUgkNlgFeB]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__dUgkNhVqyK]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__sYos6)}
                role={"img"}
              />
            ),
